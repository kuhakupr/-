...
#define GAME_WINDOW_NAME	"一般人が推しと恋をしてもいいですか？"	//ウィンドウのタイトル
...
#define KariKyara    TEXT(".\\IMAGE\\hiroin.png")//仮キャラ
...
{
	"　席替えそれはクラス生活の中で最も大事なイベントである。　+",
	"@  なぜなら今後のクラス生活を左右するものだからからである　+" ,
	"@  そして、このクラスには、学校のマドンナ的存在がの人がいる　+",
	"@  その人の名前は【桜 吹雪（さくら ふぶき）】",
	"である。　+",
	"C 主　「さて僕の席はと・・・」　+",
	"@　「左から2列目の6番目・・・窓際の近くだからあたりだな」　+",
	"@　(面倒ごとは避けたいし)　+",
	"@　(隣はマドンナじゃなければ誰でもいいや)　+",
	"C  ピコン　フラグが立つ音がした  +",
	"@ (寝よう) +",
	...
	"@　顔が真っ青になるのがわかった　+",
	"@　それと同時にクラスのほとんどから殺気が　+",
	"@ （ヤバい、ヤバい、ヤバい、ヤバい）内心焦っていた　+",
	"@  なぜなら、彼女にはファンクラブがある。+",
	"@  だが、そこらのファンクラブとは格が違う+",
	"@  なぜなら、",
	"@  所属している人数は",
	"@  全校生徒男女関係なく約8割が所属しているのである",
	"@　なお、所属していない生徒は美男美女である　+",
	"C (どうするべきか)　+",
	"@  2.　返事をする",
	"@  3.　無視をする　Q",
	"2C　待てゴラァ！！！！！　+",
